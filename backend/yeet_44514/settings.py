"""
Django settings for yeet_44514 project.
...
WSGI_APPLICATION = 'yeet_44514.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "yeet_44514 API",
    "DESCRIPTION": "API documentation for yeet_44514 App",
    "VERSION": "v1",
}
